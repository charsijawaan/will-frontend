  ...
  render() {
    return (
      ...
      <div className="container">
        <div className="row">
          <div className="col">
          <Link to="/admin/flyer"><button className="but-left">Manage PDF Flyer</button></Link>
          <br />
          <Link to="/admin/manageusers"><button className="but-left"> Manage B2B/Ambassador Account</button></Link>
          <br />
          <Link to="/admin/setup-discount"><button className="but-left">Setup Discount</button></Link>
          <br />
          <Link to="/viewallvoucherinvoices"><button className="but-left">Generate B2B Employee Voucher Invoice</button></Link>
          <br />
          </div>
          <div className="col">
          <Link to="/admin/org-user-listing"><button className="but-left">Manage Organisation Users</button></Link>
          <br />
          <Link to="/productsprice"><button className="but-left">Set up Products Price</button></Link>
          <br />
          <Link to="/admin/sales"><button className="but-left">See all sales</button></Link>
          <br />
          <Link to="/admin/managebalance"><button className="but-left">Manage User Balance</button></Link>
          <br />
          </div>
      </div>
    </div>
