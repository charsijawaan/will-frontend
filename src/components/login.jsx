    ...
    return (
      <div className="global-container">
        <div className="container">
          ...
          <br />
        <div className="login-form col-xl-3 col-lg-6 col-md-8 col-sm-10 p-4" style={{paddingTop:"10%"}}>
          ...
          <Link to="/registeration"><button className="button">Register</button></Link>
        </div>
        {/* <div className="bottom-login">
          <Link to="/register/indivdualUser">Individual User</Link><br />
          <Link to="/register/b2b">B2B Client</Link><br />
          <Link to="/register/will-ambassador">Will Ambassador</Link><br />
        </div> */}
      </div>
