                    ...
                    <div key={i + 1}>
                        ...
                        {values.step7AssetDetails[i].assetType ===
                            ...
                            <Form.Group controlId="tenant">
                                <Form.Label>
                                    Who is the property due to after the death
                                    of life tenant?
                                </Form.Label>
                                <Form.Control
                                    name="tenant"
                                    ...
                                    onChange={(e) => {
                                        values.step7AssetDetails[i].tenant =
                                            e.target.value;
                                        changeState(
                                            values.step7AssetDetails[i].tenant
                                        );
                        ...
                        <Form.Group controlId="description">
                            ...
                            <Form.Control
                                ...
                                onChange={(e) => {
                                    values.step7AssetDetails[i].desc =
                                        e.target.value;
                                    changeState(
                                        values.step7AssetDetails[i].desc
                                    );
                        ...
                        <Form.Group controlId="amount">
                            ...
                            <Form.Control
                                ...
                                onChange={(e) => {
                                    values.step7AssetDetails[i].value =
                                        e.target.value;
                                    changeState(
                                        values.step7AssetDetails[i].value
                                    );
                        ...
                        <Form.Group controlId="doclocation">
                            ...
                            <Form.Control
                                ...
                                onChange={(e) => {
                                    values.step7AssetDetails[
                                        i
                                    ].documentLocation = e.target.value;
                                    changeState(
                                        values.step7AssetDetails[i]
                                            .documentLocation
                                    );
                                }}
                            ></Form.Control>
                        ...
                        <input
                            ...
                            type="file"
                            onChange={(e) => {
                                values.step7AssetDetails[i].assetFile =
                                    e.target.files[0];
                                onFileChange(
                                    values.step7AssetDetails[i].assetFile
                                );
                        ...
                        <button
                            ...
                            onClick={(e) => {
                                ...
                                for (
                                    var j = 0;
                                    j < values.step7AssetDetails.length;
                                    j++
                                ) {
                                    if (
                                        i + 1 ===
                                        values.step7AssetDetails[j].index
                                    ) {
                                        foo = i;
                                        break;
                                    }
