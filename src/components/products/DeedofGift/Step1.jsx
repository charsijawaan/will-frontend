        ...
        <div className="container">
            ...
            <Form className="l-form">
                ...
                <Form.Group>
                    ...
                    <select className="form-control" value={values.countryOfGift} onChange={(e) => {handleChange("countryOfGift", e)}}>
                ...
                <Form.Group>
                    ...
                    <Form.Control value={values.dateOfTransfer} type="date" onChange={(e) => {handleChange("dateOfTransfer", e)}}></Form.Control>
                </Form.Group>
