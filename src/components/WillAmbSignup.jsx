...
const RegisterWillAmbassador = () => {
  ...
  <div className="container">
    ...
    <br />
  <div className="reg-form col-xl-3 col-lg-6 col-md-8 col-sm-10" style={{paddingTop:"10%"}}>
    <div className="container col-md-6">
      <h4>Will Ambassador Registration</h4>
      <br />
      <Form>
        ...
        <button className="button" onClick={handleCamera}>Take Selfie</button>
        {camera && (
          <>
            <Webcam
              audio={false}
    ...
    <div className="container p-4">
        <Link to="/registeration"><button className="button">Back</button></Link>
    </div>
    </div>
  );
};
